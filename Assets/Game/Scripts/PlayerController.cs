namespace PofyTools.TomHax
{
    ...
    public class PlayerController : GameActor
    {
        ...
        public void LookTarget(Transform target = null)
        {
            ...
            this.cameraTarget.position = this.transform.position;
        }
        #endregion

        #region Standard Asset
        [SerializeField]
        ...
        private void Flip()
        {
            ...
            //Vector3 localTargetPosition = this.cameraTarget.localPosition;
            //localTargetPosition.x *= -1;
            //this.cameraTarget.localPosition = localTargetPosition;
